...
pub fn start_oauth_flow(provider: OAuthProvider, session_store: &OAuthSessionManager) -> String {
...
pub async fn handle_oauth_callback(
    ...
    let session_state = match session_store.consume(&state) {
        Some(state) => state,
        None => {
    ...
    // Store the tokens securely associated with the user.
}
